...
$test->setup_discovery("-ORBDebugLevel 1 -DCPSPendingTimeout 200 -ORBLogFile DCPSInfoRepo.log") unless $rtps;
...
$test->process("publisher5", "model/publisher5", $pub_opts);
$test->process("publisher6", "model/publisher6", $pub_opts);
$test->process("publisher7", "model/publisher7", $pub_opts);
$test->process("publisher8", "model/publisher8", $pub_opts);
$test->process("publisher9", "model/publisher9", $pub_opts);
$test->process("publisher10", "model/publisher10", $sub_opts);
...
$test->process("subscriber5", "model/subscriber5", $sub_opts);
$test->process("subscriber6", "model/subscriber6", $sub_opts);
$test->process("subscriber4", "model/subscriber4", $sub_opts);
$test->process("subscriber7", "model/subscriber7", $sub_opts);
